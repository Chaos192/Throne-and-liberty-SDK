...
public:
	...
	uint8                                         Pad_4B0[0xE0];                                     // 0x04B0(0x00E0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	FMulticastInlineDelegateProperty_             OnChaosPhysicsCollision;                           // 0x06B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_6E8[0x218];                                    // 0x06E8(0x0218)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UGeometryCollectionComponent, ChaosSolverActor) == 0x0004A8, "Member 'UGeometryCollectionComponent::ChaosSolverActor' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, RestCollection) == 0x000590, "Member 'UGeometryCollectionComponent::RestCollection' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, InitializationFields) == 0x000598, "Member 'UGeometryCollectionComponent::InitializationFields' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, Simulating) == 0x0005A8, "Member 'UGeometryCollectionComponent::Simulating' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, ObjectType) == 0x0005B0, "Member 'UGeometryCollectionComponent::ObjectType' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, EnableClustering) == 0x0005B1, "Member 'UGeometryCollectionComponent::EnableClustering' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, ClusterGroupIndex) == 0x0005B4, "Member 'UGeometryCollectionComponent::ClusterGroupIndex' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, MaxClusterLevel) == 0x0005B8, "Member 'UGeometryCollectionComponent::MaxClusterLevel' has a wrong offset!");
...
static_assert(offsetof(UGeometryCollectionComponent, ClusterConnectionType) == 0x0005D0, "Member 'UGeometryCollectionComponent::ClusterConnectionType' has a wrong offset!");
...
static_assert(offsetof(UGeometryCollectionComponent, InitialLinearVelocity) == 0x0005F4, "Member 'UGeometryCollectionComponent::InitialLinearVelocity' has a wrong offset!");
...
static_assert(offsetof(UGeometryCollectionComponent, PhysicalMaterialOverride) == 0x000610, "Member 'UGeometryCollectionComponent::PhysicalMaterialOverride' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, CacheParameters) == 0x000618, "Member 'UGeometryCollectionComponent::CacheParameters' has a wrong offset!");
...
static_assert(offsetof(UGeometryCollectionComponent, bEnableReplication) == 0x0006CA, "Member 'UGeometryCollectionComponent::bEnableReplication' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, bEnableAbandonAfterLevel) == 0x0006CB, "Member 'UGeometryCollectionComponent::bEnableAbandonAfterLevel' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, ReplicationAbandonClusterLevel) == 0x0006CC, "Member 'UGeometryCollectionComponent::ReplicationAbandonClusterLevel' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, RepData) == 0x0006D0, "Member 'UGeometryCollectionComponent::RepData' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, DummyBodySetup) == 0x000900, "Member 'UGeometryCollectionComponent::DummyBodySetup' has a wrong offset!");
