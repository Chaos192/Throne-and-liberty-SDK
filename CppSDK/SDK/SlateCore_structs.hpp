...
public:
	...
	struct FSlateBrush                            PanelHoveredVerticalBackgroundImage;               // 0x04D0(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            PanelHoveredHorizontalBackgroundImage;             // 0x0558(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FScrollBarStyle) == 0x000008, "Wrong alignment on FScrollBarStyle");
static_assert(sizeof(FScrollBarStyle) == 0x0005E0, "Wrong size on FScrollBarStyle");
...
static_assert(offsetof(FScrollBarStyle, PanelHoveredVerticalBackgroundImage) == 0x0004D0, "Member 'FScrollBarStyle::PanelHoveredVerticalBackgroundImage' has a wrong offset!");
static_assert(offsetof(FScrollBarStyle, PanelHoveredHorizontalBackgroundImage) == 0x000558, "Member 'FScrollBarStyle::PanelHoveredHorizontalBackgroundImage' has a wrong offset!");
...
public:
	...
	struct FScrollBarStyle                        ScrollBarStyle;                                    // 0x0328(0x05E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FEditableTextBoxStyle) == 0x000008, "Wrong alignment on FEditableTextBoxStyle");
static_assert(sizeof(FEditableTextBoxStyle) == 0x000908, "Wrong size on FEditableTextBoxStyle");
...
{
public:
	struct FEditableTextBoxStyle                  TextBoxStyle;                                      // 0x0008(0x0908)(Edit, NativeAccessSpecifierPublic)
	struct FSlateFontInfo                         ActiveFontInfo;                                    // 0x0910(0x0058)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateBrush                            UpArrowImage;                                      // 0x0968(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            DownArrowImage;                                    // 0x09F0(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            GlassImage;                                        // 0x0A78(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ClearImage;                                        // 0x0B00(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FMargin                                ImagePadding;                                      // 0x0B88(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bLeftAlignButtons;                                 // 0x0B98(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FSearchBoxStyle) == 0x000BA0, "Wrong size on FSearchBoxStyle");
static_assert(offsetof(FSearchBoxStyle, TextBoxStyle) == 0x000008, "Member 'FSearchBoxStyle::TextBoxStyle' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ActiveFontInfo) == 0x000910, "Member 'FSearchBoxStyle::ActiveFontInfo' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, UpArrowImage) == 0x000968, "Member 'FSearchBoxStyle::UpArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, DownArrowImage) == 0x0009F0, "Member 'FSearchBoxStyle::DownArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, GlassImage) == 0x000A78, "Member 'FSearchBoxStyle::GlassImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ClearImage) == 0x000B00, "Member 'FSearchBoxStyle::ClearImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ImagePadding) == 0x000B88, "Member 'FSearchBoxStyle::ImagePadding' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignButtons) == 0x000B98, "Member 'FSearchBoxStyle::bLeftAlignButtons' has a wrong offset!");
...
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0008(0x0908)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FTextBlockStyle                        TextStyle;                                         // 0x0910(0x0270)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FInlineEditableTextBlockStyle) == 0x000008, "Wrong alignment on FInlineEditableTextBlockStyle");
static_assert(sizeof(FInlineEditableTextBlockStyle) == 0x000B80, "Wrong size on FInlineEditableTextBlockStyle");
...
static_assert(offsetof(FInlineEditableTextBlockStyle, TextStyle) == 0x000910, "Member 'FInlineEditableTextBlockStyle::TextStyle' has a wrong offset!");
