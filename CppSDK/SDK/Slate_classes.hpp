...
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0030(0x0908)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000938, "Wrong size on UEditableTextBoxWidgetStyle");
...
{
public:
	struct FScrollBarStyle                        ScrollBarStyle;                                    // 0x0030(0x05E0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScrollBarWidgetStyle) == 0x000610, "Wrong size on UScrollBarWidgetStyle");
