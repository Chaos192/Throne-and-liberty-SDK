...
// int32                                   HostMinusRenderTGMinusListMinusIndex                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UNinjaLiveFunctions_C::AcquireRenderTargetsFromPool(int32 Request_0_RGBA__1_RG__2_R_, int32 HostMinusRenderTGMinusListMinusIndex, TArray<class FString>& RenderTargetList, class UObject* __WorldContext, TMap<class FString, class UTextureRenderTarget2D*>* RenderTargetsMapTmp)
{
	static class UFunction* Func = nullptr;
	...
	Parms.HostMinusRenderTGMinusListMinusIndex = HostMinusRenderTGMinusListMinusIndex;
...
// (Static, Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UObject*                          SelfRef                                                (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   RT_number_Minus_added                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UNinjaLiveFunctions_C::RenderTgAcquisitionStatus(const class UObject* SelfRef, int32 RT_number_Minus_added, ESimPrecision_Enum SimPrecision, int32 ResX, int32 ResY, bool PoolManDetected, bool HalfRes, int32 NumberOfChannels, class UObject* __WorldContext, class FString* Print, float* MemConsumtion)
{
	static class UFunction* Func = nullptr;
	...
	Parms.RT_number_Minus_added = RT_number_Minus_added;
