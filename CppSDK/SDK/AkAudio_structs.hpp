...
// ScriptStruct AkAudio.MovieSceneAkAudioEventTemplateNew
// 0x0008 (0x0028 - 0x0020)
struct FMovieSceneAkAudioEventTemplateNew final : public FMovieSceneEvalTemplate
{
public:
...
static_assert(alignof(FMovieSceneAkAudioEventTemplateNew) == 0x000008, "Wrong alignment on FMovieSceneAkAudioEventTemplateNew");
static_assert(sizeof(FMovieSceneAkAudioEventTemplateNew) == 0x000028, "Wrong size on FMovieSceneAkAudioEventTemplateNew");
static_assert(offsetof(FMovieSceneAkAudioEventTemplateNew, Section) == 0x000020, "Member 'FMovieSceneAkAudioEventTemplateNew::Section' has a wrong offset!");
