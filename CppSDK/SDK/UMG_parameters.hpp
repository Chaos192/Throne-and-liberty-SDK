...
static_assert(alignof(ListViewBase_SetAllowOverscroll) == 0x000001, "Wrong alignment on ListViewBase_SetAllowOverscroll");
static_assert(sizeof(ListViewBase_SetAllowOverscroll) == 0x000001, "Wrong size on ListViewBase_SetAllowOverscroll");
static_assert(offsetof(ListViewBase_SetAllowOverscroll, NewAllowOverscroll) == 0x000000, "Member 'ListViewBase_SetAllowOverscroll::NewAllowOverscroll' has a wrong offset!");

// Function UMG.ListViewBase.SetScrollBarSizeOverride
// 0x0004 (0x0004 - 0x0000)
struct ListViewBase_SetScrollBarSizeOverride final
{
public:
...
static_assert(alignof(ListViewBase_SetScrollBarSizeOverride) == 0x000004, "Wrong alignment on ListViewBase_SetScrollBarSizeOverride");
static_assert(sizeof(ListViewBase_SetScrollBarSizeOverride) == 0x000004, "Wrong size on ListViewBase_SetScrollBarSizeOverride");
static_assert(offsetof(ListViewBase_SetScrollBarSizeOverride, InScrollBarSizeOverride) == 0x000000, "Member 'ListViewBase_SetScrollBarSizeOverride::InScrollBarSizeOverride' has a wrong offset!");
