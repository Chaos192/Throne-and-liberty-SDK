...
// Function Landscape.LandscapeGrassType.ExposeParticleParameter
// (Final, Native, Public)

void ULandscapeGrassType::ExposeParticleParameter()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LandscapeGrassType", "ExposeParticleParameter");
