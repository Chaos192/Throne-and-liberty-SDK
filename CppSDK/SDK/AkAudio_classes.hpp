...
public:
	...
	uint8                                         Pad_211[0xBF];                                     // 0x0211(0x00BF)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AAkAcousticPortal) == 0x0002B8, "Wrong size on AAkAcousticPortal");
static_assert(offsetof(AAkAcousticPortal, Portal) == 0x0002A8, "Member 'AAkAcousticPortal::Portal' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, InitialState) == 0x0002B0, "Member 'AAkAcousticPortal::InitialState' has a wrong offset!");
static_assert(offsetof(AAkAcousticPortal, bRequiresStateMigration) == 0x0002B1, "Member 'AAkAcousticPortal::bRequiresStateMigration' has a wrong offset!");
...
static_assert(sizeof(UAkAudioBank) == 0x0000D0, "Wrong size on UAkAudioBank");
...
static_assert(offsetof(UAkAudioBank, bIsLocalized) == 0x0000A8, "Member 'UAkAudioBank::bIsLocalized' has a wrong offset!");
static_assert(offsetof(UAkAudioBank, CurrentLocalizedPlatformAssetData) == 0x0000B0, "Member 'UAkAudioBank::CurrentLocalizedPlatformAssetData' has a wrong offset!");
...
public:
	...
	bool                                          StoreMediaInBank;                                  // 0x00C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AutoPrepare;                                       // 0x00C1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          SyncPrepare;                                       // 0x00C2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PreventPostEventBasedOnDist;                       // 0x00C3(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinDistToPreventPostEvent;                         // 0x00C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPlayOnlyIfOwner;                                  // 0x00C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkAudioEvent, CurrentLocalizedPlatformData) == 0x0000A8, "Member 'UAkAudioEvent::CurrentLocalizedPlatformData' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MaxAttenuationRadius) == 0x0000B0, "Member 'UAkAudioEvent::MaxAttenuationRadius' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, IsInfinite) == 0x0000B4, "Member 'UAkAudioEvent::IsInfinite' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MinimumDuration) == 0x0000B8, "Member 'UAkAudioEvent::MinimumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MaximumDuration) == 0x0000BC, "Member 'UAkAudioEvent::MaximumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, StoreMediaInBank) == 0x0000C0, "Member 'UAkAudioEvent::StoreMediaInBank' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, AutoPrepare) == 0x0000C1, "Member 'UAkAudioEvent::AutoPrepare' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, SyncPrepare) == 0x0000C2, "Member 'UAkAudioEvent::SyncPrepare' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, PreventPostEventBasedOnDist) == 0x0000C3, "Member 'UAkAudioEvent::PreventPostEventBasedOnDist' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MinDistToPreventPostEvent) == 0x0000C4, "Member 'UAkAudioEvent::MinDistToPreventPostEvent' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, bPlayOnlyIfOwner) == 0x0000C8, "Member 'UAkAudioEvent::bPlayOnlyIfOwner' has a wrong offset!");
...
public:
	...
	bool                                          EnableSpotReflectors;                              // 0x0231(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_232[0x2];                                      // 0x0232(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OuterRadius;                                       // 0x0234(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         InnerRadius;                                       // 0x0238(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          DrawFirstOrderReflections;                         // 0x0274(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DrawSecondOrderReflections;                        // 0x0275(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DrawHigherOrderReflections;                        // 0x0276(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          DrawDiffraction;                                   // 0x0277(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_285[0x16B];                                    // 0x0285(0x016B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UAkComponent, EnableSpotReflectors) == 0x000231, "Member 'UAkComponent::EnableSpotReflectors' has a wrong offset!");
static_assert(offsetof(UAkComponent, OuterRadius) == 0x000234, "Member 'UAkComponent::OuterRadius' has a wrong offset!");
static_assert(offsetof(UAkComponent, InnerRadius) == 0x000238, "Member 'UAkComponent::InnerRadius' has a wrong offset!");
...
static_assert(offsetof(UAkComponent, DrawFirstOrderReflections) == 0x000274, "Member 'UAkComponent::DrawFirstOrderReflections' has a wrong offset!");
static_assert(offsetof(UAkComponent, DrawSecondOrderReflections) == 0x000275, "Member 'UAkComponent::DrawSecondOrderReflections' has a wrong offset!");
static_assert(offsetof(UAkComponent, DrawHigherOrderReflections) == 0x000276, "Member 'UAkComponent::DrawHigherOrderReflections' has a wrong offset!");
static_assert(offsetof(UAkComponent, DrawDiffraction) == 0x000277, "Member 'UAkComponent::DrawDiffraction' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneAkAudioEventSection) == 0x000208, "Wrong size on UMovieSceneAkAudioEventSection");
...
static_assert(offsetof(UMovieSceneAkAudioEventSection, EnableAutoSeek) == 0x0001D0, "Member 'UMovieSceneAkAudioEventSection::EnableAutoSeek' has a wrong offset!");
static_assert(offsetof(UMovieSceneAkAudioEventSection, RawVoiceText) == 0x0001D8, "Member 'UMovieSceneAkAudioEventSection::RawVoiceText' has a wrong offset!");
static_assert(offsetof(UMovieSceneAkAudioEventSection, AttachSocketName) == 0x0001F0, "Member 'UMovieSceneAkAudioEventSection::AttachSocketName' has a wrong offset!");
static_assert(offsetof(UMovieSceneAkAudioEventSection, StartTimeSecOffset) == 0x0001F8, "Member 'UMovieSceneAkAudioEventSection::StartTimeSecOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneAkAudioEventSection, FadeInDurationSec) == 0x0001FC, "Member 'UMovieSceneAkAudioEventSection::FadeInDurationSec' has a wrong offset!");
static_assert(offsetof(UMovieSceneAkAudioEventSection, FadeOutDurationSec) == 0x000200, "Member 'UMovieSceneAkAudioEventSection::FadeOutDurationSec' has a wrong offset!");
...
public:
	...
	bool                                          bEnableDiffraction;                                // 0x0298(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableDiffractionOnBoundaryEdges;                 // 0x0299(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkGeometryComponent, bEnableDiffraction) == 0x000298, "Member 'UAkGeometryComponent::bEnableDiffraction' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, bEnableDiffractionOnBoundaryEdges) == 0x000299, "Member 'UAkGeometryComponent::bEnableDiffractionOnBoundaryEdges' has a wrong offset!");
...
static_assert(offsetof(UAkLateReverbComponent, bEnable) == 0x000208, "Member 'UAkLateReverbComponent::bEnable' has a wrong offset!");
...
{
public:
	bool                                          bEnabled;                                          // 0x02A8(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAkReverbVolume) == 0x0002E0, "Wrong size on AAkReverbVolume");
static_assert(offsetof(AAkReverbVolume, bEnabled) == 0x0002A8, "Member 'AAkReverbVolume::bEnabled' has a wrong offset!");
static_assert(offsetof(AAkReverbVolume, AuxBus) == 0x0002B0, "Member 'AAkReverbVolume::AuxBus' has a wrong offset!");
static_assert(offsetof(AAkReverbVolume, AuxBusName) == 0x0002B8, "Member 'AAkReverbVolume::AuxBusName' has a wrong offset!");
static_assert(offsetof(AAkReverbVolume, SendLevel) == 0x0002C8, "Member 'AAkReverbVolume::SendLevel' has a wrong offset!");
static_assert(offsetof(AAkReverbVolume, FadeRate) == 0x0002CC, "Member 'AAkReverbVolume::FadeRate' has a wrong offset!");
static_assert(offsetof(AAkReverbVolume, Priority) == 0x0002D0, "Member 'AAkReverbVolume::Priority' has a wrong offset!");
static_assert(offsetof(AAkReverbVolume, LateReverbComponent) == 0x0002D8, "Member 'AAkReverbVolume::LateReverbComponent' has a wrong offset!");
...
public:
	...
	bool                                          bDynamic;                                          // 0x0229(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_22A[0x2];                                      // 0x022A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Priority;                                          // 0x022C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WallOcclusion;                                     // 0x0230(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AuxSendLevel;                                      // 0x0234(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AutoPost;                                          // 0x0238(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, SimpleDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkRoomComponent, bEnable) == 0x000228, "Member 'UAkRoomComponent::bEnable' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, bDynamic) == 0x000229, "Member 'UAkRoomComponent::bDynamic' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, Priority) == 0x00022C, "Member 'UAkRoomComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, WallOcclusion) == 0x000230, "Member 'UAkRoomComponent::WallOcclusion' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AuxSendLevel) == 0x000234, "Member 'UAkRoomComponent::AuxSendLevel' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, AutoPost) == 0x000238, "Member 'UAkRoomComponent::AutoPost' has a wrong offset!");
...
static_assert(offsetof(UAkSettings, PlayRawVoiceEventForSequence) == 0x0002E0, "Member 'UAkSettings::PlayRawVoiceEventForSequence' has a wrong offset!");
static_assert(offsetof(UAkSettings, PlayRawVoice3DEventForSequence) == 0x0002F8, "Member 'UAkSettings::PlayRawVoice3DEventForSequence' has a wrong offset!");
...
static_assert(sizeof(UAkSettingsPerUser) == 0x0000B8, "Wrong size on UAkSettingsPerUser");
...
static_assert(offsetof(UAkSettingsPerUser, AutoMuteOtherWorldListeners) == 0x000080, "Member 'UAkSettingsPerUser::AutoMuteOtherWorldListeners' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, EditorListenerOffset) == 0x000084, "Member 'UAkSettingsPerUser::EditorListenerOffset' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, ShowEditorListener) == 0x000090, "Member 'UAkSettingsPerUser::ShowEditorListener' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, OffsetHeightFromGround) == 0x000094, "Member 'UAkSettingsPerUser::OffsetHeightFromGround' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, MultiListener_ShowSubListeners) == 0x000098, "Member 'UAkSettingsPerUser::MultiListener_ShowSubListeners' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, MultiListener_MaxDistFromCamera) == 0x00009C, "Member 'UAkSettingsPerUser::MultiListener_MaxDistFromCamera' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, MultiListener_TransitionPower) == 0x0000A0, "Member 'UAkSettingsPerUser::MultiListener_TransitionPower' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, MultiListener_DistBetweenSubs) == 0x0000A4, "Member 'UAkSettingsPerUser::MultiListener_DistBetweenSubs' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, MultiListener_MainListenerVolume) == 0x0000A8, "Member 'UAkSettingsPerUser::MultiListener_MainListenerVolume' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, MultiListener_SubListener1Volume) == 0x0000AC, "Member 'UAkSettingsPerUser::MultiListener_SubListener1Volume' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, MultiListener_SubListener2Volume) == 0x0000B0, "Member 'UAkSettingsPerUser::MultiListener_SubListener2Volume' has a wrong offset!");
static_assert(offsetof(UAkSettingsPerUser, MultiListener_SubListener3Volume) == 0x0000B4, "Member 'UAkSettingsPerUser::MultiListener_SubListener3Volume' has a wrong offset!");
...
static_assert(sizeof(AAkSpatialAudioVolume) == 0x0002C0, "Wrong size on AAkSpatialAudioVolume");
static_assert(offsetof(AAkSpatialAudioVolume, SurfaceReflectorSet) == 0x0002A8, "Member 'AAkSpatialAudioVolume::SurfaceReflectorSet' has a wrong offset!");
static_assert(offsetof(AAkSpatialAudioVolume, LateReverb) == 0x0002B0, "Member 'AAkSpatialAudioVolume::LateReverb' has a wrong offset!");
static_assert(offsetof(AAkSpatialAudioVolume, Room) == 0x0002B8, "Member 'AAkSpatialAudioVolume::Room' has a wrong offset!");
...
static_assert(offsetof(AAkSpotReflector, EarlyReflectionAuxBus) == 0x000230, "Member 'AAkSpotReflector::EarlyReflectionAuxBus' has a wrong offset!");
static_assert(offsetof(AAkSpotReflector, EarlyReflectionAuxBusName) == 0x000238, "Member 'AAkSpotReflector::EarlyReflectionAuxBusName' has a wrong offset!");
...
{
public:
	bool                                          bEnableSurfaceReflectors;                          // 0x0220(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bEnableDiffraction;                                // 0x0238(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableDiffractionOnBoundaryEdges;                 // 0x0239(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UAkSurfaceReflectorSetComponent, bEnableSurfaceReflectors) == 0x000220, "Member 'UAkSurfaceReflectorSetComponent::bEnableSurfaceReflectors' has a wrong offset!");
...
static_assert(offsetof(UAkSurfaceReflectorSetComponent, bEnableDiffraction) == 0x000238, "Member 'UAkSurfaceReflectorSetComponent::bEnableDiffraction' has a wrong offset!");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, bEnableDiffractionOnBoundaryEdges) == 0x000239, "Member 'UAkSurfaceReflectorSetComponent::bEnableDiffractionOnBoundaryEdges' has a wrong offset!");
...
public:
	...
	struct FMovieSceneFloatChannel                RTPCChannel;                                       // 0x0180(0x00A0)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneAkAudioRTPCSection) == 0x000220, "Wrong size on UMovieSceneAkAudioRTPCSection");
...
static_assert(offsetof(UMovieSceneAkAudioRTPCSection, RTPCChannel) == 0x000180, "Member 'UMovieSceneAkAudioRTPCSection::RTPCChannel' has a wrong offset!");
