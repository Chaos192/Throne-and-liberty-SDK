...
static_assert(offsetof(UCanvasPanel, bUseLayerIDThreshold) == 0x000120, "Member 'UCanvasPanel::bUseLayerIDThreshold' has a wrong offset!");
...
public:
	...
	TDelegate<void()>                             HintTextDelegate;                                  // 0x0A58(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	...
	FMulticastInlineDelegateProperty_             OnTextChanged;                                     // 0x0B18(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTextCommitted;                                   // 0x0B28(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBox) == 0x000B48, "Wrong size on UEditableTextBox");
...
static_assert(offsetof(UEditableTextBox, Style) == 0x000A38, "Member 'UEditableTextBox::Style' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, HintText) == 0x000A40, "Member 'UEditableTextBox::HintText' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, HintTextDelegate) == 0x000A58, "Member 'UEditableTextBox::HintTextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Font) == 0x000A68, "Member 'UEditableTextBox::Font' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ForegroundColor) == 0x000AC0, "Member 'UEditableTextBox::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, BackgroundColor) == 0x000AD0, "Member 'UEditableTextBox::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ReadOnlyForegroundColor) == 0x000AE0, "Member 'UEditableTextBox::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsReadOnly) == 0x000AF0, "Member 'UEditableTextBox::IsReadOnly' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsPassword) == 0x000AF1, "Member 'UEditableTextBox::IsPassword' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, MinimumDesiredWidth) == 0x000AF4, "Member 'UEditableTextBox::MinimumDesiredWidth' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Padding) == 0x000AF8, "Member 'UEditableTextBox::Padding' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsCaretMovedWhenGainFocus) == 0x000B08, "Member 'UEditableTextBox::IsCaretMovedWhenGainFocus' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, SelectAllTextWhenFocused) == 0x000B09, "Member 'UEditableTextBox::SelectAllTextWhenFocused' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, RevertTextOnEscape) == 0x000B0A, "Member 'UEditableTextBox::RevertTextOnEscape' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ClearKeyboardFocusOnCommit) == 0x000B0B, "Member 'UEditableTextBox::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, SelectAllTextOnCommit) == 0x000B0C, "Member 'UEditableTextBox::SelectAllTextOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, AllowContextMenu) == 0x000B0D, "Member 'UEditableTextBox::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, KeyboardType) == 0x000B0E, "Member 'UEditableTextBox::KeyboardType' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardOptions) == 0x000B0F, "Member 'UEditableTextBox::VirtualKeyboardOptions' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardTrigger) == 0x000B10, "Member 'UEditableTextBox::VirtualKeyboardTrigger' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardDismissAction) == 0x000B11, "Member 'UEditableTextBox::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Justification) == 0x000B12, "Member 'UEditableTextBox::Justification' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ShapedTextOptions) == 0x000B13, "Member 'UEditableTextBox::ShapedTextOptions' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OnTextChanged) == 0x000B18, "Member 'UEditableTextBox::OnTextChanged' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OnTextCommitted) == 0x000B28, "Member 'UEditableTextBox::OnTextCommitted' has a wrong offset!");
...
public:
	...
	uint8                                         bOverride_ScrollBarSizeOverride : 1;               // 0x0124(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
static_assert(offsetof(UListViewBase, AllowOverscroll) == 0x00011C, "Member 'UListViewBase::AllowOverscroll' has a wrong offset!");
static_assert(offsetof(UListViewBase, ScrollBarSizeOverride) == 0x000120, "Member 'UListViewBase::ScrollBarSizeOverride' has a wrong offset!");
static_assert(offsetof(UListViewBase, bScrollbarLeft) == 0x000125, "Member 'UListViewBase::bScrollbarLeft' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             OnTextChanged;                                     // 0x0D78(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnTextCommitted;                                   // 0x0D88(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMultiLineEditableTextBox) == 0x000DA8, "Wrong size on UMultiLineEditableTextBox");
...
static_assert(offsetof(UMultiLineEditableTextBox, TextStyle) == 0x000A70, "Member 'UMultiLineEditableTextBox::TextStyle' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, bIsReadOnly) == 0x000CE0, "Member 'UMultiLineEditableTextBox::bIsReadOnly' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, AllowContextMenu) == 0x000CE1, "Member 'UMultiLineEditableTextBox::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, VirtualKeyboardOptions) == 0x000CE2, "Member 'UMultiLineEditableTextBox::VirtualKeyboardOptions' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, VirtualKeyboardDismissAction) == 0x000CE3, "Member 'UMultiLineEditableTextBox::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, Style) == 0x000CE8, "Member 'UMultiLineEditableTextBox::Style' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, Font) == 0x000CF0, "Member 'UMultiLineEditableTextBox::Font' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, ForegroundColor) == 0x000D48, "Member 'UMultiLineEditableTextBox::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, BackgroundColor) == 0x000D58, "Member 'UMultiLineEditableTextBox::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, ReadOnlyForegroundColor) == 0x000D68, "Member 'UMultiLineEditableTextBox::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, OnTextChanged) == 0x000D78, "Member 'UMultiLineEditableTextBox::OnTextChanged' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, OnTextCommitted) == 0x000D88, "Member 'UMultiLineEditableTextBox::OnTextCommitted' has a wrong offset!");
...
static_assert(sizeof(UScrollBar) == 0x000720, "Wrong size on UScrollBar");
static_assert(offsetof(UScrollBar, WidgetStyle) == 0x000108, "Member 'UScrollBar::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UScrollBar, Style) == 0x0006E8, "Member 'UScrollBar::Style' has a wrong offset!");
static_assert(offsetof(UScrollBar, bAlwaysShowScrollbar) == 0x0006F0, "Member 'UScrollBar::bAlwaysShowScrollbar' has a wrong offset!");
static_assert(offsetof(UScrollBar, bAlwaysShowScrollbarTrack) == 0x0006F1, "Member 'UScrollBar::bAlwaysShowScrollbarTrack' has a wrong offset!");
static_assert(offsetof(UScrollBar, Orientation) == 0x0006F2, "Member 'UScrollBar::Orientation' has a wrong offset!");
static_assert(offsetof(UScrollBar, Thickness) == 0x0006F4, "Member 'UScrollBar::Thickness' has a wrong offset!");
static_assert(offsetof(UScrollBar, Padding) == 0x0006FC, "Member 'UScrollBar::Padding' has a wrong offset!");

// Class UMG.ScrollBox
// 0x0870 (0x0990 - 0x0120)
...
public:
	...
	FMulticastInlineDelegateProperty_             OnUserScrolled;                                    // 0x0968(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScrollBox) == 0x000990, "Wrong size on UScrollBox");
...
static_assert(offsetof(UScrollBox, Style) == 0x000928, "Member 'UScrollBox::Style' has a wrong offset!");
static_assert(offsetof(UScrollBox, BarStyle) == 0x000930, "Member 'UScrollBox::BarStyle' has a wrong offset!");
static_assert(offsetof(UScrollBox, Orientation) == 0x000938, "Member 'UScrollBox::Orientation' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollBarVisibility) == 0x000939, "Member 'UScrollBox::ScrollBarVisibility' has a wrong offset!");
static_assert(offsetof(UScrollBox, ConsumeMouseWheel) == 0x00093A, "Member 'UScrollBox::ConsumeMouseWheel' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollbarThickness) == 0x00093C, "Member 'UScrollBox::ScrollbarThickness' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollbarPadding) == 0x000944, "Member 'UScrollBox::ScrollbarPadding' has a wrong offset!");
static_assert(offsetof(UScrollBox, AlwaysShowScrollbar) == 0x000954, "Member 'UScrollBox::AlwaysShowScrollbar' has a wrong offset!");
static_assert(offsetof(UScrollBox, AlwaysShowScrollbarTrack) == 0x000955, "Member 'UScrollBox::AlwaysShowScrollbarTrack' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollbarRight) == 0x000956, "Member 'UScrollBox::ScrollbarRight' has a wrong offset!");
static_assert(offsetof(UScrollBox, AllowOverscroll) == 0x000957, "Member 'UScrollBox::AllowOverscroll' has a wrong offset!");
static_assert(offsetof(UScrollBox, bAnimateWheelScrolling) == 0x000958, "Member 'UScrollBox::bAnimateWheelScrolling' has a wrong offset!");
static_assert(offsetof(UScrollBox, NavigationDestination) == 0x000959, "Member 'UScrollBox::NavigationDestination' has a wrong offset!");
static_assert(offsetof(UScrollBox, NavigationScrollPadding) == 0x00095C, "Member 'UScrollBox::NavigationScrollPadding' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollWhenFocusChanges) == 0x000960, "Member 'UScrollBox::ScrollWhenFocusChanges' has a wrong offset!");
static_assert(offsetof(UScrollBox, bAllowRightClickDragScrolling) == 0x000961, "Member 'UScrollBox::bAllowRightClickDragScrolling' has a wrong offset!");
static_assert(offsetof(UScrollBox, WheelScrollMultiplier) == 0x000964, "Member 'UScrollBox::WheelScrollMultiplier' has a wrong offset!");
static_assert(offsetof(UScrollBox, OnUserScrolled) == 0x000968, "Member 'UScrollBox::OnUserScrolled' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_571[0x27];                                     // 0x0571(0x0027)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UWidgetComponent, Space) == 0x0004A0, "Member 'UWidgetComponent::Space' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TimingPolicy) == 0x0004A1, "Member 'UWidgetComponent::TimingPolicy' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WidgetClass) == 0x0004A8, "Member 'UWidgetComponent::WidgetClass' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, DrawSize) == 0x0004B0, "Member 'UWidgetComponent::DrawSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bManuallyRedraw) == 0x0004B8, "Member 'UWidgetComponent::bManuallyRedraw' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bRedrawRequested) == 0x0004B9, "Member 'UWidgetComponent::bRedrawRequested' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, RedrawTime) == 0x0004BC, "Member 'UWidgetComponent::RedrawTime' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CurrentDrawSize) == 0x0004C8, "Member 'UWidgetComponent::CurrentDrawSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bDrawAtDesiredSize) == 0x0004D0, "Member 'UWidgetComponent::bDrawAtDesiredSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Pivot) == 0x0004D4, "Member 'UWidgetComponent::Pivot' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bReceiveHardwareInput) == 0x0004DC, "Member 'UWidgetComponent::bReceiveHardwareInput' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bWindowFocusable) == 0x0004DD, "Member 'UWidgetComponent::bWindowFocusable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WindowVisibility) == 0x0004DE, "Member 'UWidgetComponent::WindowVisibility' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bApplyGammaCorrection) == 0x0004DF, "Member 'UWidgetComponent::bApplyGammaCorrection' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OwnerPlayer) == 0x0004E0, "Member 'UWidgetComponent::OwnerPlayer' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BackgroundColor) == 0x0004E8, "Member 'UWidgetComponent::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TintColorAndOpacity) == 0x0004F8, "Member 'UWidgetComponent::TintColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpacityFromTexture) == 0x000508, "Member 'UWidgetComponent::OpacityFromTexture' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BlendMode) == 0x00050C, "Member 'UWidgetComponent::BlendMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bIsTwoSided) == 0x00050D, "Member 'UWidgetComponent::bIsTwoSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TickWhenOffscreen) == 0x00050E, "Member 'UWidgetComponent::TickWhenOffscreen' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BodySetup) == 0x000510, "Member 'UWidgetComponent::BodySetup' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TranslucentMaterial) == 0x000518, "Member 'UWidgetComponent::TranslucentMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TranslucentMaterial_OneSided) == 0x000520, "Member 'UWidgetComponent::TranslucentMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpaqueMaterial) == 0x000528, "Member 'UWidgetComponent::OpaqueMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpaqueMaterial_OneSided) == 0x000530, "Member 'UWidgetComponent::OpaqueMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaskedMaterial) == 0x000538, "Member 'UWidgetComponent::MaskedMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaskedMaterial_OneSided) == 0x000540, "Member 'UWidgetComponent::MaskedMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, RenderTarget) == 0x000548, "Member 'UWidgetComponent::RenderTarget' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaterialInstance) == 0x000550, "Member 'UWidgetComponent::MaterialInstance' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bAddedToScreen) == 0x000558, "Member 'UWidgetComponent::bAddedToScreen' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bEditTimeUsable) == 0x000559, "Member 'UWidgetComponent::bEditTimeUsable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, SharedLayerName) == 0x00055C, "Member 'UWidgetComponent::SharedLayerName' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, LayerZOrder) == 0x000564, "Member 'UWidgetComponent::LayerZOrder' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, GeometryMode) == 0x000568, "Member 'UWidgetComponent::GeometryMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CylinderArcAngle) == 0x00056C, "Member 'UWidgetComponent::CylinderArcAngle' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TickMode) == 0x000570, "Member 'UWidgetComponent::TickMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Widget) == 0x000598, "Member 'UWidgetComponent::Widget' has a wrong offset!");
