...
public:
	...
	static void AcquireRenderTargetsFromPool(int32 Request_0_RGBA__1_RG__2_R_, int32 HostMinusRenderTGMinusListMinusIndex, TArray<class FString>& RenderTargetList, class UObject* __WorldContext, TMap<class FString, class UTextureRenderTarget2D*>* RenderTargetsMapTmp);
	static void RenderTgAcquisitionStatus(const class UObject* SelfRef, int32 RT_number_Minus_added, ESimPrecision_Enum SimPrecision, int32 ResX, int32 ResY, bool PoolManDetected, bool HalfRes, int32 NumberOfChannels, class UObject* __WorldContext, class FString* Print, float* MemConsumtion);
...
static_assert(sizeof(UNinjaLiveFunctions_C) == 0x000028, "Wrong size on UNinjaLiveFunctions_C");
