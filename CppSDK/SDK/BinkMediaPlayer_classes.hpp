...
public:
	...
	bool                                          bManualPlay;                                       // 0x0074(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCloseWhenReachedEnd;                              // 0x0075(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_76[0x2];                                       // 0x0076(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         DelayedOpen : 1;                                   // 0x0078(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(UBinkMediaPlayer, bManualPlay) == 0x000074, "Member 'UBinkMediaPlayer::bManualPlay' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, bCloseWhenReachedEnd) == 0x000075, "Member 'UBinkMediaPlayer::bCloseWhenReachedEnd' has a wrong offset!");
