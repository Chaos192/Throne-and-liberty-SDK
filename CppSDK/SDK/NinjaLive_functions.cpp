...
// Function NinjaLive.NinjaLive_C.OnActivatedByPawnProximity__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void ANinjaLive_C::OnActivatedByPawnProximity__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NinjaLive_C", "OnActivatedByPawnProximity__DelegateSignature");
...
void ANinjaLive_C::ActorDestroyed(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NinjaLive_C", "ActorDestroyed");

	Params::NinjaLive_C_ActorDestroyed Parms{};
