...
public:
	...
	TArray<class ULandscapeGrassType*>            LayerGrassTypes;                                   // 0x0398(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	uint8                                         BitPad_3AC_3 : 5;                                  // 0x03AC(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	...
	float                                         CollisionThickness;                                // 0x03F0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ALandscapeProxy, LayerGrassTypes) == 0x000398, "Member 'ALandscapeProxy::LayerGrassTypes' has a wrong offset!");
...
static_assert(offsetof(ALandscapeProxy, CollisionThickness) == 0x0003F0, "Member 'ALandscapeProxy::CollisionThickness' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_620[0x70];                                     // 0x0620(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FTLGrassParticleSetting                GrassParticleSetting;                              // 0x0040(0x0060)(Edit, NativeAccessSpecifierPublic)
	class UStaticMesh*                            GrassMesh;                                         // 0x00A0(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GrassDensity;                                      // 0x00A8(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlacementJitter;                                   // 0x00AC(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         StartCullDistance;                                 // 0x00B0(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         EndCullDistance;                                   // 0x00B4(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          RandomRotation;                                    // 0x00B8(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AlignToSurface;                                    // 0x00B9(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_BA[0x6];                                       // 0x00BA(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ExposeParticleParameter();
...
static_assert(sizeof(ULandscapeGrassType) == 0x0000C0, "Wrong size on ULandscapeGrassType");
...
static_assert(offsetof(ULandscapeGrassType, GrassParticleSetting) == 0x000040, "Member 'ULandscapeGrassType::GrassParticleSetting' has a wrong offset!");
static_assert(offsetof(ULandscapeGrassType, GrassMesh) == 0x0000A0, "Member 'ULandscapeGrassType::GrassMesh' has a wrong offset!");
static_assert(offsetof(ULandscapeGrassType, GrassDensity) == 0x0000A8, "Member 'ULandscapeGrassType::GrassDensity' has a wrong offset!");
static_assert(offsetof(ULandscapeGrassType, PlacementJitter) == 0x0000AC, "Member 'ULandscapeGrassType::PlacementJitter' has a wrong offset!");
static_assert(offsetof(ULandscapeGrassType, StartCullDistance) == 0x0000B0, "Member 'ULandscapeGrassType::StartCullDistance' has a wrong offset!");
static_assert(offsetof(ULandscapeGrassType, EndCullDistance) == 0x0000B4, "Member 'ULandscapeGrassType::EndCullDistance' has a wrong offset!");
static_assert(offsetof(ULandscapeGrassType, RandomRotation) == 0x0000B8, "Member 'ULandscapeGrassType::RandomRotation' has a wrong offset!");
static_assert(offsetof(ULandscapeGrassType, AlignToSurface) == 0x0000B9, "Member 'ULandscapeGrassType::AlignToSurface' has a wrong offset!");
