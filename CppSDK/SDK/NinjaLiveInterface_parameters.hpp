...
static_assert(sizeof(NinjaLiveInterface_C_LiveActivation) == 0x000010, "Wrong size on NinjaLiveInterface_C_LiveActivation");
...
static_assert(offsetof(NinjaLiveInterface_C_LiveActivation, FadeTimeOfCanvas) == 0x00000C, "Member 'NinjaLiveInterface_C_LiveActivation::FadeTimeOfCanvas' has a wrong offset!");
