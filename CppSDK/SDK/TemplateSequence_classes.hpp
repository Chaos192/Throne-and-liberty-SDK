...
public:
	...
	uint8                                         Pad_63C[0x44];                                     // 0x063C(0x0044)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USequenceCameraShakeCameraStandIn) == 0x000680, "Wrong size on USequenceCameraShakeCameraStandIn");
...
static_assert(offsetof(USequenceCameraShakeCameraStandIn, PostProcessBlendWeight) == 0x0005B0, "Member 'USequenceCameraShakeCameraStandIn::PostProcessBlendWeight' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, Filmback) == 0x0005B4, "Member 'USequenceCameraShakeCameraStandIn::Filmback' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, LensSettings) == 0x0005C0, "Member 'USequenceCameraShakeCameraStandIn::LensSettings' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, FocusSettings) == 0x0005D8, "Member 'USequenceCameraShakeCameraStandIn::FocusSettings' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentFocalLength) == 0x000630, "Member 'USequenceCameraShakeCameraStandIn::CurrentFocalLength' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentAperture) == 0x000634, "Member 'USequenceCameraShakeCameraStandIn::CurrentAperture' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentFocusDistance) == 0x000638, "Member 'USequenceCameraShakeCameraStandIn::CurrentFocusDistance' has a wrong offset!");
