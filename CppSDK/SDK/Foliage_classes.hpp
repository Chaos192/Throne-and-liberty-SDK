...
{
public:
	class AProceduralFoliageVolume*               ProceduralFoliageVolume;                           // 0x02A8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AProceduralFoliageBlockingVolume) == 0x0002B0, "Wrong size on AProceduralFoliageBlockingVolume");
...
{
public:
	class UProceduralFoliageComponent*            ProceduralComponent;                               // 0x02A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
