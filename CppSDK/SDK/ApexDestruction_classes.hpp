...
public:
	...
	FMulticastInlineDelegateProperty_             OnComponentFracture;                               // 0x0700(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_710[0xA0];                                     // 0x0710(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UDestructibleComponent, FractureEffects) == 0x0006D8, "Member 'UDestructibleComponent::FractureEffects' has a wrong offset!");
static_assert(offsetof(UDestructibleComponent, bEnableHardSleeping) == 0x0006E8, "Member 'UDestructibleComponent::bEnableHardSleeping' has a wrong offset!");
static_assert(offsetof(UDestructibleComponent, LargeChunkThreshold) == 0x0006EC, "Member 'UDestructibleComponent::LargeChunkThreshold' has a wrong offset!");
static_assert(offsetof(UDestructibleComponent, OnComponentFracture) == 0x000700, "Member 'UDestructibleComponent::OnComponentFracture' has a wrong offset!");
...
{
public:
	struct FDestructibleParameters                DefaultDestructibleParameters;                     // 0x03D8(0x0088)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FFractureEffect>                FractureEffects;                                   // 0x0460(0x0010)(Edit, EditFixedSize, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDestructibleMesh) == 0x000478, "Wrong size on UDestructibleMesh");
static_assert(offsetof(UDestructibleMesh, DefaultDestructibleParameters) == 0x0003D8, "Member 'UDestructibleMesh::DefaultDestructibleParameters' has a wrong offset!");
static_assert(offsetof(UDestructibleMesh, FractureEffects) == 0x000460, "Member 'UDestructibleMesh::FractureEffects' has a wrong offset!");
