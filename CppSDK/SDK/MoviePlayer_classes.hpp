...
public:
	...
	EMoviePlaybackType                            PlaybackType;                                      // 0x002A(0x0001)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMoviePlayerSettings, PlaybackType) == 0x00002A, "Member 'UMoviePlayerSettings::PlaybackType' has a wrong offset!");
