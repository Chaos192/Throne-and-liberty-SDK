...
public:
	...
	int32                                         DebugChannelS;                                     // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UTexture2D*                             DataTexture;                                       // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             LayerContributionTexture;                          // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture2D*                             DirtyTexture;                                      // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLandscapeEditToolRenderData) == 0x000008, "Wrong alignment on FLandscapeEditToolRenderData");
static_assert(sizeof(FLandscapeEditToolRenderData) == 0x000040, "Wrong size on FLandscapeEditToolRenderData");
...
static_assert(offsetof(FLandscapeEditToolRenderData, DebugChannelS) == 0x000020, "Member 'FLandscapeEditToolRenderData::DebugChannelS' has a wrong offset!");
static_assert(offsetof(FLandscapeEditToolRenderData, DataTexture) == 0x000028, "Member 'FLandscapeEditToolRenderData::DataTexture' has a wrong offset!");
static_assert(offsetof(FLandscapeEditToolRenderData, LayerContributionTexture) == 0x000030, "Member 'FLandscapeEditToolRenderData::LayerContributionTexture' has a wrong offset!");
static_assert(offsetof(FLandscapeEditToolRenderData, DirtyTexture) == 0x000038, "Member 'FLandscapeEditToolRenderData::DirtyTexture' has a wrong offset!");
...
// ScriptStruct Landscape.TLGrassParticleSetting
// 0x0060 (0x0060 - 0x0000)
struct FTLGrassParticleSetting final
{
public:
	bool                                          bEnableGrassParticle;                              // 0x0000(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<struct FParticleSysParam>              InstanceParameters;                                // 0x0030(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         ParticleRadius;                                    // 0x0040(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CellRadius;                                        // 0x0044(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SpawnRadius;                                       // 0x0048(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LowRestrictWeight;                                 // 0x004C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinLifeTime;                                       // 0x0050(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxLifeTime;                                       // 0x0054(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MinRestTime;                                       // 0x0058(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxRestTime;                                       // 0x005C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTLGrassParticleSetting) == 0x000008, "Wrong alignment on FTLGrassParticleSetting");
static_assert(sizeof(FTLGrassParticleSetting) == 0x000060, "Wrong size on FTLGrassParticleSetting");
static_assert(offsetof(FTLGrassParticleSetting, bEnableGrassParticle) == 0x000000, "Member 'FTLGrassParticleSetting::bEnableGrassParticle' has a wrong offset!");
static_assert(offsetof(FTLGrassParticleSetting, ParticleSystem) == 0x000008, "Member 'FTLGrassParticleSetting::ParticleSystem' has a wrong offset!");
static_assert(offsetof(FTLGrassParticleSetting, InstanceParameters) == 0x000030, "Member 'FTLGrassParticleSetting::InstanceParameters' has a wrong offset!");
static_assert(offsetof(FTLGrassParticleSetting, ParticleRadius) == 0x000040, "Member 'FTLGrassParticleSetting::ParticleRadius' has a wrong offset!");
static_assert(offsetof(FTLGrassParticleSetting, CellRadius) == 0x000044, "Member 'FTLGrassParticleSetting::CellRadius' has a wrong offset!");
static_assert(offsetof(FTLGrassParticleSetting, SpawnRadius) == 0x000048, "Member 'FTLGrassParticleSetting::SpawnRadius' has a wrong offset!");
static_assert(offsetof(FTLGrassParticleSetting, LowRestrictWeight) == 0x00004C, "Member 'FTLGrassParticleSetting::LowRestrictWeight' has a wrong offset!");
static_assert(offsetof(FTLGrassParticleSetting, MinLifeTime) == 0x000050, "Member 'FTLGrassParticleSetting::MinLifeTime' has a wrong offset!");
static_assert(offsetof(FTLGrassParticleSetting, MaxLifeTime) == 0x000054, "Member 'FTLGrassParticleSetting::MaxLifeTime' has a wrong offset!");
static_assert(offsetof(FTLGrassParticleSetting, MinRestTime) == 0x000058, "Member 'FTLGrassParticleSetting::MinRestTime' has a wrong offset!");
static_assert(offsetof(FTLGrassParticleSetting, MaxRestTime) == 0x00005C, "Member 'FTLGrassParticleSetting::MaxRestTime' has a wrong offset!");
